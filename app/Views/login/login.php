...
<html lang="en">
	<head><base href="../../../">
		...
		<link href="<?php echo base_url();?>/assets/plugins/global/plugins1.bundle.css" rel="stylesheet" type="text/css" />
					...
					<div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
						<form class="form w-100" novalidate="novalidate" id="login_form" method="post" >
							...
							<div class="fv-row mb-10">
								...
								<span id="emailid" style="display:none;color:red">Email address is required</span>
